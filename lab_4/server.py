...
"""
	...
	Taken from https://docs.twistedmatrix.com/en/twisted-16.6.0/core/examples/#ftp-examples
	Modified by: Srikar
"""
...
# Making a server share directory to use as root

if not os.path.isdir(server_root_path):
	os.makedirs(server_root_path)

p = Portal(FTPRealm(server_root_path),
